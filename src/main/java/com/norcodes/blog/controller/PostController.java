...
import com.norcodes.blog.utils.AppConstants;
...
public class PostController {
    ...
    @Operation(
            ...
            description = "Save a post into the database"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Update Post REST API is used to update a single post from the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Http Status 200 SUCCESS"
